...
class WhitelessSpider(Spider):
    name = 'Whiteless'
    allowed_domains = []
    currency_symbol_map = {'£': 'GBP', '$': 'USD', '€': 'EUR'}

    def __init__(self, *a, **kw):
        super(WhitelessSpider, self).__init__(*a, **kw)
        self._pagination_pattern = re.compile('^https?:.*[\\?&]page=\\d{1}$')
        self.urls = [{"value": "http://thewhiteless.tictail.com/products/clothing/jacket-coat", "gender": ["women"]}, {"value": "http://thewhiteless.tictail.com/products/clothing/blazar", "gender": ["women"]}, {"value": "http://thewhiteless.tictail.com/products/clothing/blou", "gender": ["women"]}, {"value": "http://thewhiteless.tictail.com/products/clothing/jeans", "gender": ["women"]}, {"value": "http://thewhiteless.tictail.com/products/clothing/skirt-dress", "gender": ["women"]}, {"value": "http://thewhiteless.tictail.com/products/clothing/bag", "gender": ["women"]}]
