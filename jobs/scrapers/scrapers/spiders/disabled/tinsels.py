...
class TinselsSpider(Spider):
    name = 'Tinsels'

    def __init__(self, *a, **kw):
        super(TinselsSpider, self).__init__(*a, **kw)
        self.urls = [
            {"value": "https://tinsels.fr/en/15-tops-and-shirts", "gender": ["women"]},
            {"value": "https://tinsels.fr/en/15-tops-and-shirts", "gender": ["women"]},
            {"value": "https://tinsels.fr/en/18-dresses", "gender": ["women"]},
            {"value": "https://tinsels.fr/en/19-trousers-and-shorts", "gender": ["women"]},
            {"value": "https://tinsels.fr/en/4-jackets-and-coats", "gender": ["women"]},
            {"value": "https://tinsels.fr/en/8-sweaters-and-t-shirts", "gender": ["women"]},
            {"value": "https://tinsels.fr/en/17-skirts", "gender": ["women"]},
        ]
    ...
    def get_image_urls(self, response):
        urls = response.xpath('//a[contains(@class, "fancybox")]/@href').extract()
        return urls
