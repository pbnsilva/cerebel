...
class AsquithSpider(Spider):
    name = 'Asquith'
    allowed_domains = []
    currency_symbol_map = {'£': 'GBP', '$': 'USD', '€': 'EUR'}

    def __init__(self, *a, **kw):
        super(AsquithSpider, self).__init__(*a, **kw)
        self._pagination_pattern = re.compile('^https?:.*[\\?&]page=\\d{1}$')
        self.urls = [{"value": "https://www.asquithlondon.com/tops/", "gender": ["women"]}, {"value": "https://www.asquithlondon.com/bottoms/", "gender": ["women"]}, {"value": "https://www.asquithlondon.com/lifestyle/underwear/", "gender": ["women"]}]
