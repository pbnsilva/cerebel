...
class GranaSpider(Spider):
    name = 'Grana'
    allowed_domains = []
    currency_symbol_map = {'£': 'GBP', '$': 'USD', '€': 'EUR'}

    def __init__(self, *a, **kw):
        super(GranaSpider, self).__init__(*a, **kw)
        self._pagination_pattern = re.compile('^https?:.*[\\?&]page=\\d{1}$')
        self.urls = [
            {"value": "https://www.grana.com/women/top/tanks-camis", "gender": ["women"]},
            {"value": "https://www.grana.com/women/top/shirts-blouses", "gender": ["women"]},
            {"value": "https://www.grana.com/women/bottom/jeans", "gender": ["women"]},
            {"value": "https://www.grana.com/women/bottom/pants-joggers", "gender": ["women"]},
            {"value": "https://www.grana.com/women/dresses", "gender": ["women"]},
            {"value": "https://www.grana.com/women/top/sweaters-cardigans", "gender": ["women"]},
            {"value": "https://www.grana.com/women/top/tees", "gender": ["women"]},
            {"value": "https://www.grana.com/women/coats-jackets", "gender": ["women"]},
            {"value": "https://www.grana.com/women/bottom/shorts-skirts", "gender": ["women"]},
            {"value": "https://www.grana.com/women/underwear", "gender": ["women"]},
            {"value": "https://www.grana.com/women/swim", "gender": ["women"]},
            {"value": "https://www.grana.com/women/sleepwear", "gender": ["women"]},
            {"value": "https://www.grana.com/men/bottom/pants-joggers", "gender": ["men"]},
            {"value": "https://www.grana.com/men/bottom/jeans", "gender": ["men"]},
            {"value": "https://www.grana.com/men/top/tees", "gender": ["men"]},
            {"value": "https://www.grana.com/men/top/sweaters-cardigans", "gender": ["men"]},
            {"value": "https://www.grana.com/men/top/polos-shirts", "gender": ["men"]},
            {"value": "https://www.grana.com/men/bottom/shorts", "gender": ["men"]},
            {"value": "https://www.grana.com/men/coats-jackets", "gender": ["men"]},
            {"value": "https://www.grana.com/men/underwear", "gender": ["men"]},
            {"value": "https://www.grana.com/men/swim", "gender": ["men"]},
        ]
    ...
    def parse_store(self, response):
        ...
        for url in product_urls:
            ...
            if self._is_pagination_url(url):
                yield Request(url, callback=self.parse_store, meta={'brand': response.meta['brand'], 'gender': response.meta['gender']})
            else:
