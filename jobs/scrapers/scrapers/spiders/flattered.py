...
class FlatteredSpider(Spider):
    name = 'Flattered'
    allowed_domains = []
    currency_symbol_map = {'£': 'GBP', '$': 'USD', '€': 'EUR'}

    def __init__(self, *a, **kw):
        super(FlatteredSpider, self).__init__(*a, **kw)
        self._pagination_pattern = re.compile('^https?:.*[\\?&]page=\\d{1}$')
        self.urls = [{"value": "https://flattered.se/en/product-category/sandaler-en/", "gender": ["women"]}, {"value": "https://flattered.se/en/product-category/ballet-flats-en/", "gender": ["women"]}, {"value": "https://flattered.se/en/product-category/loafers-en/", "gender": ["women"]}, {"value": "https://flattered.se/en/product-category/pumps-en/", "gender": ["women"]}, {"value": "https://flattered.se/en/product-category/boots/", "gender": ["women"]}, {"value": "https://flattered.se/en/product-category/wedding-shoes/", "gender": ["women"]}, {"value": "https://flattered.se/en/product-category/indoor-shoes/", "gender": ["women"]}, {"value": "https://flattered.se/en/product-category/vegan-shoes/", "gender": ["women"]}]
