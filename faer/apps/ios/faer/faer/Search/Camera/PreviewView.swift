...
class PreviewView: UIView {
    ...
    private func commonInit() {
        self.clipsToBounds = true //otherwise resizeAspectFill might lead previewView to exceed view bounds
...
class PreviewView: UIView, UIGestureRecognizerDelegate {
    ...
    private func commonInit() {
        ...
        self.clipsToBounds = true //otherwise resizeAspectFill might lead previewView to exceed view bounds
        self.videoPreviewLayer.videoGravity = AVLayerVideoGravity.resizeAspectFill // make preview fullscreen
