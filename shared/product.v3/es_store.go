...
func (s *ESStore) GetByField(ctx context.Context, key, value string, size int) ([]*Item, error) {
...
func (s *ESStore) DeleteByQuery(ctx context.Context, q elastic.Query) error {
